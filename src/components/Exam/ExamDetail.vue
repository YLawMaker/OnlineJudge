                    ...
                    <tr>   
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td v-if="this.examHistory.examCompletionQuestionTotals==1111">否</td>
                            <td v-else>是</td>
                        </tr>
                         <tr>
    ...
    methods: {
        ...
        gotoChoice(){
            if(this.examHistory.examChoiceQuestionTotals=='1111'){
                this.$router.replace({path:'/examChoice',query:{
                    userId:this.userId,
        ...
        gotoProgram(){
            if(this.examHistory.examCompletionQuestionTotals!='1111'){
                this.$router.replace({path:'/examProgramming',query:{
                    userId:this.userId,
                    examId:this.examInfo.examId,
                    examName:this.examInfo.examName,
                    examEndTime:this.examInfo.examEndTime,
        ...
        gotoCompletion(){
            if(this.examHistory.examCompletionQuestionTotals=='1111'&&this.examHistory.examChoiceQuestionTotals!='1111'){
                this.$router.replace({path:'/examCompletion',query:{
                    userId:this.userId,
                    examId:this.examInfo.examId,
                    examName:this.examInfo.examName,
                    examEndTime:this.examInfo.examEndTime,
