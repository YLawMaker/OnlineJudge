<template>
  <div>
        ...
        <el-table-column prop="group.groupName" label="测试组别"> </el-table-column>
        <el-table-column prop="testStartTime" label="测试开始时间"> </el-table-column>
        <el-table-column prop="testEndTime" label="测试结束时间"> </el-table-column>
        <el-table-column prop="testLanguage" label="测试语言"> </el-table-column>
        <el-table-column prop="testStatus" label="测试状态">
            <template slot-scope="scope">
                <div v-if="scope.row.testStatus==='Pending'" style="color:blue" >
                    {{scope.row.testStatus}}
                </div>
                <div v-else-if="scope.row.testStatus==='Running'" style="color:red" >
                    {{scope.row.testStatus}}
                </div>
