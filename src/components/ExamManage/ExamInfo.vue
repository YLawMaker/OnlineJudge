<template>
    <div class="paper-content">
        <div>
            ...
            <div class='container'>
                <form>
                <div class="choiceTab" v-for="(item,index) in this.examQuestions" :key="item.examQuestionId">
        ...
        <div>
            ...
            <div class='container'>
                <form>
                    <div class="completionTab" v-for="(item,index) in this.examQuestions" :key="item.examQuestionId">
        ...
        <div>
            ...
            <form>
                <div class="choiceTab" v-for="(item,index) in examQuestions" :key="item.examQuestionId">
                    <div v-if="item.exercise">
                        <div v-show="item.exercise.exerciseId">
                            <!-- 题干 -->
                            <div class="question">
                                <span class="num">第{{index+1}}题 、    {{item.exercise.exerciseTitle}}</span>
